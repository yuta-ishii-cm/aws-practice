...
**状況:**
SageMaker Pipelineの実行が「TrainModel」ステップで失敗している。
...
**状況:**
Model Monitorからデータドリフトアラートが発生した。推論精度の低下が懸念される。
...
**課題:**
SageMaker Feature Storeを導入し、特徴量の管理と再利用を効率化してください。
...
**シナリオ:**
新しいアルゴリズム（LightGBM）のモデルを本番環境で段階的に検証したい。
...
**次の課題**: [課題29](exercise-29.md)

**前の課題**: [課題27](exercise-27.md)
